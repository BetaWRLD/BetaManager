...
namespace SuRGeoNix.BitSwarmLib
{
    ...
    public class Options : ICloneable
    {
        ...
        public string FolderComplete { get; set; } =
            "C:\\BetaManager\\Torrent Cache\\Torrent Info Cache";

        /// <summary>
        /// [CP] Folder where the incomplete (part) files will be saved
        /// </summary>
        public string FolderIncomplete { get; set; } =
            Path.Combine("C:\\BetaManager\\Torrent Cache\\Torrent Info Cache", ".data");

        /// <summary>
        /// [CP] Folder where the .torrent files will be saved
        /// </summary>
        public string FolderTorrents { get; set; } =
            Path.Combine("C:\\BetaManager\\Torrent Cache\\Torrent Info Cache", ".torrents");
